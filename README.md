...
- studying C, O matrices (e.g. trace, log-det, alignment, eigenspectrum) for various tasks (e.g. perceptual, relational), architectures (e.g. CNN, GNN, Deepsets, MLP) and hyperparameter settings
  - distinct
  - 
- 
